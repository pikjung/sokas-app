        ...
        <div className="">
          <div className="float-right flex flex-wrap lg:flex-nowrap gap-4">
            ...
            <input
              ...
              min={tanggal[0]}
            />
            <button className="rounded-sm bg-indigo-500 p-2 text-white hover:bg-indigo-600" onClick={() => handleFilter && handleFilter(tanggal)}>Terapkan Filter</button>
          </div>
        </div>
        : ''
      }
